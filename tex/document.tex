\documentclass[paper=6in:9in,pagesize=pdftex,headinclude=on,footinclude=on,11pt, draft]{scrbook}
...
\section{Sortie (\emph{Check Out})} \label{protocole-sortie}
...
\begin{itemize}
	...
	\item Les questions suivantes, par exemple, sont inefficaces :
		  \begin{itemize}
		  	\item Questions orientées. % @ToF: Questions orientées, ou qui reflètent une intention.
		    \item Questions dont la réponse est sous-entendue. % @ToF: Questions dont vous sous-entendez la réponse.
		    \item Questions ouvertes aux rumeurs. % @ToF: Questions qui invitent à se raconter des histoires.
