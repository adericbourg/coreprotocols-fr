...
\begin{itemize}
	...
	\item Assurez-vous de vouloir résoudre paisiblement tout conflit potentiel avant de contrôler l'intention de qui que ce soit.
	      Si vos n'avez pas d'intentions pacifiques, sortez (\fullref{terminaison}).
...
\begin{itemize}
	...
	\item Ne posez pas de question orientées, particulièrement si vous savez quelle réponse vous allez obtenir.
...
définis par Jim McCarthy et Michele McCarthy.
