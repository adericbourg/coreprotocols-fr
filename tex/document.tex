...
Votre présente physique indique que vous respectez les Engagement Fondamentaux. Lorsque vous prenez conscience que vous ne pouvez plus
...
\subsection{Engagements}
\begin{itemize}
	\item Revenez dès que vous êtes en mesure de respecter les Engagement Fondamentaux.
